package com.lex.accounting.adapter;
...
import com.lex.accounting.entity.MenuCategory;
...
public class MenuAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item instanceof MenuCategory) {
            ...
            ((TextView) v).setText(((MenuCategory) item).getmTitle());
            ...
            tv.setText(((MenuItem) item).getmTitle());
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
                tv.setCompoundDrawablesRelativeWithIntrinsicBounds(((MenuItem) item).getmIconRes(), 0, 0, 0);
            } else {
                tv.setCompoundDrawablesWithIntrinsicBounds(((MenuItem) item).getmIconRes(), 0, 0, 0);
            }
        }
